/**
 * AI Powder Inspection Proxy Route
 *
 * Proxies POST /api/inspect/powder to the AI_Service POST /api/inspect/powder.
 ...
 *
 * Requirements: 4.2, 4.4, 4.7, 18.4, 18.5
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      const response = await fetch(`${aiServiceUrl}/api/inspect/powder`, {
        method: 'POST',
